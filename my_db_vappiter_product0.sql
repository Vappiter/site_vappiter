...
CREATE TABLE `vappiter_product` (
  ...
  `nameproduct_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `vappiter_product_company_id_06e7f91e_fk_vappiter_company_id` (`company_id`),
  KEY `vappiter_product_nameproduct_id_977776d2_fk_vappiter_` (`nameproduct_id`),
  ...
  CONSTRAINT `vappiter_product_nameproduct_id_977776d2_fk_vappiter_` FOREIGN KEY (`nameproduct_id`) REFERENCES `vappiter_nameproduct` (`id`)
